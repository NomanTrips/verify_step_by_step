...
features = Features({
    ...
    'meta': {
        ...
        'score': Value('int32'),  # or 'int32' or 'string', depending on what 'score' should be
        'question_id': Value('string')  # explicitly set as string
    }
})
dataset = load_dataset('json', data_files='./data/verify_pretrain.json', split="train", field="train") 
print(dataset)
